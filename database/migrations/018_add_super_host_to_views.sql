...
-- =====================================================
-- Fecha: 2025-12-24
-- Descripción: Actualiza v_reservations_full y v_reservations_with_host 
--              para incluir los datos del Súper Anfitrión (responsable)
--              desde alojamiento_caracteristica.id_personal_interno_responsable
-- =====================================================
...
SELECT
    ...
    -- Campos del anfitrión principal
