-- =====================================================
-- Migración 012: Actualizar vistas para usar tabla 'reserva'
-- =====================================================
-- Fecha: 2025-11-17
-- Descripción: Actualiza las vistas SQL para usar la tabla 'reserva'
--              en lugar de 'reservations', y 'viajeros'+'checkin'
--              en lugar de 'guests'
-- =====================================================
...
SELECT
    ...
    TIME(r.hora_salida) AS check_out_time,
...
-- =====================================================
-- 3. Actualizar vista v_guests_with_reservation
-- =====================================================
...
SELECT
    ...
    1 AS is_registered, -- Si está en checkin, está registrado
...
INNER JOIN accommodations a ON r.alojamiento_id = a.id;
