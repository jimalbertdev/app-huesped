-- =====================================================
-- Migración 013: Actualizar vistas para nuevas tablas
-- =====================================================
-- Fecha: 2025-11-17
-- Descripción: Actualiza las vistas SQL para usar:
--              - alojamiento (en vez de accommodations)
--              - alojamiento_caracteristica (en vez de hosts)
--              - reservas_detalles (en vez de preferences)
-- =====================================================
