<?php
/**
 * Script para ejecutar migración 013
 * Actualiza vistas SQL para usar nuevas tablas:
 * - alojamiento (accommodations)
 * - alojamiento_caracteristica (hosts)
 */
...
echo "\n===========================================\n";
echo "MIGRACIÓN 013: Actualizar vistas a nueva estructura\n";
echo "===========================================\n\n";
...
try {
    ...
    // Leer archivo SQL
    $sql_file = __DIR__ . '/migrations/013_update_views_to_new_table_structure.sql';
    ...
    echo "\n===========================================\n";
    echo "✓ MIGRACIÓN 013 COMPLETADA EXITOSAMENTE\n";
    echo "===========================================\n\n";
